...
class questionAnswerChainSelf():
    ...
    - embedding_key：使用的embedding模型的秘钥（OpenAI）
    ...
    def __init__(self, model:str, temperature:float=0.0, top_k:int=4,  file_path:str=None, persist_path:str=None, api_key:str=None, Wenxin_secret_key:str=None, embedding = "m3e", template=default_template_rq):
        self.model = model
        ...
        self.llm = model_to_llm(self.model, self.temperature, self.api_key,self.Wenxin_secret_key)
